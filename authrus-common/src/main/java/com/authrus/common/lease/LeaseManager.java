...
/**
 * A lease manager is used to provide {@link Lease} objects that can be used to
 * manage specific resources. Each lease will own a specific resource, it must
 * be renewed before it expires or it will be released and dispatched to the
 * {@link Cleaner} for disposal.
 * 
 * @author Niall Gallagher
 * 
 * @see com.authrus.common.lease.Lease<T>
 * @see com.authrus.common.lease.Cleaner<T>
 */
