 ...
 * be used to enable the window builder to determine what needs to be 
 * injected in to the method when called.
 * 
 * @author Niall Gallagher
 * 
 * @see com.authrus.common.swing.ui.annotation.ComponentOf
 * @see com.authrus.common.swing.ui.annotation.ValueOf
 */
