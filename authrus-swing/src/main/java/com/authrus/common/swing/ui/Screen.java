...
/**
 * This is the main viewable screen that is created. It is responsible for
 * building the user interface by traversing the various widgets. In order to
 * build the user interface a {@link Controller} and a {@link Context} are
 * required to managed dependencies.
 * 
 * @author Niall Gallagher
 * 
 * @see com.authrus.common.swing.ui.Context
 */
public class Screen {
