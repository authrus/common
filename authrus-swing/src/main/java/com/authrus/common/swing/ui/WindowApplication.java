 ...
 * location of a user interface XML definition file. To start the user
 * interface simply invoke the start method. This will cause the screen 
 * to be loaded from the specified XML file and controlled using 
 * the provided {@link Controller} implementation.
 * 
