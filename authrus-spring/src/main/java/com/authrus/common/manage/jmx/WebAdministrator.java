...
public class WebAdministrator {
   ...
   public void start() {
      try {
         ...
         Class type = getClass();
         Package namespace = type.getPackage();
         ...
         ObjectName serverName = new ObjectName(prefix + ":name=WebAdministratorServer,type=HtmlAdaptorServer");
         ObjectName parserName = new ObjectName(prefix + ":name=WebPageParser,type=WebPageParser");
