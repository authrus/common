...
public class SelfValidatingUpdateListener extends Thread implements TupleListener {
   ...
   public SelfValidatingUpdateListener(String prefix, AtomicInteger successes, AtomicInteger failures) {
