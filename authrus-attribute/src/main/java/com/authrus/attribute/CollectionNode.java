...
public class CollectionNode implements ObjectNode {
   ...
   public CollectionNode(SectionGenerator generator, ObjectTransformer transformer, ObjectBuilder builder, Class type) {
   ...
   public Converter getConverter(ObjectGraph graph) {
      return new CollectionConverter(generator, graph, transformer, this, type);
   }
